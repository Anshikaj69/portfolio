...
const Skills = () => {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col justify-center items-center my-[7rem]">
      ...
      <div className="mt-16 grid max-w-4xl grid-rows-[auto_auto_auto] gap-8 md:grid-cols-3 md:gap-10">
        ...
        >
          ...
          <ul className="max-w-md text-balance ml-7 mb-1 text-slate-300 bg-[#2A0E61]/20 px-3 py-[2rem] rounded-lg flex flex-row justify-evenly">
        ...
        >
          ...
          <div className="max-w-md text-balance mx-2 mb-2 text-slate-300  bg-[#2A0E61]/20 px-3 py-[2rem] rounded-lg flex flex-row justify-evenly">
